          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-24">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                  Konserva diperkuat oleh tim profesional yang berdedikasi dengan berbagai keahlian dalam bidang konservasi, ekologi, dan pemberdayaan masyarakat.
                </p>
              </div>
                ...
                {teamMembers.map((member) => (
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-forest-600 font-medium mb-4">{member.position}</p>
            ...
            <div className="mb-24">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                  Kami bekerja sama dengan berbagai organisasi dan lembaga untuk mencapai misi konservasi yang lebih besar dan lebih efektif.
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
                {partners.map((partner) => (
                  <div 
                    key={partner.id} 
                    className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-all border border-gray-100 flex items-center justify-center aspect-square"
                  >
                    <img 
                      src={partner.logo} 
                      alt={partner.name} 
            ...
            <div className="bg-forest-50 rounded-xl p-8 border border-forest-100 text-center">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Bergabung dengan Kami</h3>
              <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                Kami selalu terbuka untuk kolaborasi dan partisipasi. Jika Anda tertarik untuk bergabung dengan upaya konservasi kami, silakan hubungi kami.
              </p>
