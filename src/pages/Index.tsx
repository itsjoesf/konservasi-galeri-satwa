              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4 bg-gray-50 p-4 rounded-xl">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Melindungi spesies terancam punah melalui pengembangan cagar alam dan kerja sama dengan komunitas lokal.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 bg-gray-50 p-4 rounded-xl">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Mengembangkan program edukasi untuk meningkatkan kesadaran masyarakat tentang pentingnya konservasi satwa.
                    </p>
                  </div>
                </div>
              </div>
